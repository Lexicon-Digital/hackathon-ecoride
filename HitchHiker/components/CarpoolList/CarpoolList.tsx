...
export const CarpoolList: React.FC<ICarpoolList> = ({navigation}) => {
    ...
    const [carpoolList, setCarpoolList] = React.useState<ICarpoolTrips>(initialCarpoolList);
    ...
    const addCarpool = (newCarpool: Omit<ICarpoolTripData, 'driver'>) => {
        setCarpoolList({...carpoolList, [ECarpoolTopic.FUTURE]: [...carpoolList?.[ECarpoolTopic.FUTURE], {...currDriver, ...newCarpool}]});
    }
    ...
    return (
        <ScrollView>
            <Layout>
                ...
                {openCarpoolForm && (
                    <AddCarpoolForm controlClose={controlForm} isOpen={openCarpoolForm} addCarpool={addCarpool} />
                )}
            </Layout>
        </ScrollView>
    );
...
const CarpoolTopicAccordion: React.FC<ICarpoolTopicAccordion> = ({navigation, controlAccordion, carpoolTopic, carpools, isExpanded}) => {
    return (
        <ListItem.Accordion
            ...
            content={
                <View style={styles.accordion}>
                    <ListItem.Title style={styles.accordionTitle}>{carpoolTopicTitles[carpoolTopic]}</ListItem.Title>
                </View>
            }
