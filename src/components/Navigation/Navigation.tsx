...
export const Navigation = () => {
  ...
  const JoinOrganisationWithName: React.VFC<{
    navigation: Navigation;
  }> = props => <JoinOrganisation organisationName={orgToJoin} {...props} />;
  // Using some hardcoded markers for demo purposes
  const MapWithMarkers: React.VFC<{navigation: Navigation}> = props => (
    <Map
      {...props}
      markers={[
        [-37.7712, 144.9998],
